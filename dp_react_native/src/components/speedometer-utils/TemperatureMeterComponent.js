...
class TemperatureMeterComponent extends Component {
  constructor(props) {
    super(props);
...
TemperatureMeterComponent.defaultProps = {
  defaultValue: 0,
  minValue: 0,
  maxValue: 200,
  easeDuration: 500,
...
TemperatureMeterComponent.propTypes = {
...
export default TemperatureMeterComponent;
